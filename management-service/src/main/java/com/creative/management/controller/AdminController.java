...
public class AdminController {
    ...
    public ResponseEntity<?> createAdvertisement(@RequestBody AdContentRequest advertisementRequest, @PathVariable String userId){
    ...
    @CircuitBreaker(name = "management", fallbackMethod = "managementFallback")
    public ResponseEntity<?> updateAdvertisement(@RequestBody AdContentRequest advertisementRequest ,@PathVariable String advertisementId){
    ...
    @CircuitBreaker(name = "management", fallbackMethod = "managementFallback")
    public ResponseEntity<AdContent> getAdvertisementById(@PathVariable String advertisementId){
